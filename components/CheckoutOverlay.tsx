      ...
      <div className="relative bg-white rounded-2xl max-w-[400px] md:max-w-[440px] w-full max-h-[calc(100dvh-2.5rem)] overflow-y-auto overscroll-contain p-7 text-center border border-line shadow-2xl">
        {step === "pay" && (
          <div>
            ...
            <div className="mt-4 rounded-2xl border border-[#39e5b6]/40 bg-[rgba(57,229,182,.06)] p-4">
              <div className="flex items-start gap-3">
                <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-[rgba(57,229,182,.15)]">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#39e5b6" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
