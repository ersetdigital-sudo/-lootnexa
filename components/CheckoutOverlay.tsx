      ...
      <div className="relative bg-white rounded-2xl max-w-[400px] md:max-w-[440px] w-full max-h-[calc(100dvh-2.5rem)] overflow-y-auto overscroll-contain p-7 text-center border border-line shadow-2xl">
        {step === "pay" && (
          <div>
            ...
            <div className="mt-4 rounded-2xl border border-[#39e5b6]/40 bg-[rgba(57,229,182,.06)] p-4 text-left md:flex md:items-center md:gap-4">
              <div className="hidden md:block shrink-0">
                <svg width="38" height="38" viewBox="0 0 24 24" fill="none" stroke="#39e5b6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-80">
              ...
              {waUrl ? (
                <a
                  ...
                  className="mt-3 md:mt-0 flex shrink-0 items-center justify-center gap-2 w-full md:w-auto rounded-xl bg-[rgba(57,229,182,.15)] px-4 md:px-5 py-2.5 text-xs font-bold text-[#39e5b6] transition hover:bg-[rgba(57,229,182,.25)]"
                >
                ...
                <p className="mt-2 md:mt-0 md:max-w-[190px] shrink-0 text-[11px] text-grey">Nomor WhatsApp belum diatur admin. Hubungi admin untuk bantuan.</p>
              )}
            </div>
